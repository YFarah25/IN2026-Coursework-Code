...
public:
	...
	void SetSpaceshipShape(shared_ptr<Shape> spaceship_shape) { mAlienSpaceshipShape = spaceship_shape; }
	void SetThrusterShape(shared_ptr<Shape> thruster_shape) { mAlienThrusterShape = thruster_shape; }
	void SetBulletShape(shared_ptr<Shape> bullet_shape) { mAlienBulletShape = bullet_shape; }
